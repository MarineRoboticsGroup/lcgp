...
class Swarm:
	...
	def getGradientOfNthEigenval(self, n):
		# get eigen pair
		nthEigenpair = mat_utils.getEigpairLeastFirst(self.relDistanceMatrix, n-1)
		if not (nthEigenpair[0] > 0):
			return False

		gradient = mat_utils.getGradientOfMatrixForEigenpair(self.relDistanceMatrix, nthEigenpair, self.robot_graph)
		return gradient
	...
	def printAllEigvals(self):
		eigvals = mat_utils.getListOfAllEigvals(self.relDistanceMatrix)
		eigvals.sort()
		print(eigvals)
