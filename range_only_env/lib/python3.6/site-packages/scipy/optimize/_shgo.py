...
class SHGO(object):
    def __init__(self, func, bounds, args=(), constraints=None, n=None,
        ...
        self._N_SAMPLEd = 0  # To track number of sampling points already generated
    ...
    def iterate_hypercube(self):
        ...
        if self._N_SAMPLEd == 0:
            ...
            self.HC = Complex(self.dim, self.func, self.args,
                              self.symmetry, self._bounds, self.g_cons,
                              self.g_args)
        else:
        ...
        self._N_SAMPLEd = self.HC.V.size  # nevs counted in triangulation.py
        return
    ...
    def construct_lcb_simplicial(self, v_min):
        ...
        """
        cbounds = [[x_b_i[0], x_b_i[1]] for x_b_i in self._bounds]
    ...
    def sampling_sobol(self, n, dim):
        ...
        if self._N_SAMPLEd == 0:
            ...
            self.C = self.sobol_points(n, dim, skip=self._N_SAMPLEd)
