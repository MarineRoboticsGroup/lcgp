...
class TestDifferentialEvolutionSolver(object):
    ...
    def test_maxiter_stops_solve(self):
        ...
        # the solver stops.
        solver = DifferentialEvolutionSolver(rosen, self._bounds, maxiter=1)
        result = solver.solve()
    ...
    def test_maxfun_stops_solve(self):
        ...
        solver = DifferentialEvolutionSolver(rosen, self._bounds, maxfun=1,
                                             polish=False)
        result = solver.solve()
    ...
    def test_calculate_population_energies(self):
        ...
        solver = DifferentialEvolutionSolver(rosen, self._bounds, popsize=3)
    ...
    def test_iteration(self):
        ...
        solver = DifferentialEvolutionSolver(rosen, self._bounds)
    ...
    def test_convergence(self):
        solver = DifferentialEvolutionSolver(rosen, self._bounds, tol=0.2,
                                             polish=False)
        solver.solve()
    ...
    def test_maxiter_none_GH5731(self):
        ...
        # in the solve method.
        solver = DifferentialEvolutionSolver(rosen, self._bounds, maxiter=None,
                                             maxfun=None)
        solver.solve()
