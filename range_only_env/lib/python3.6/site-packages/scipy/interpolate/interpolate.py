...
class interp2d(object):
    ...
    def __call__(self, x, y, dx=0, dy=0, assume_sorted=False):
        ...
        if self._bounds_error or self.fill_value is not None:
        ...
        if self._bounds_error and (any_out_of_bounds_x or any_out_of_bounds_y):
...
class interp1d(_Interpolator1D):
    ...
    def __init__(self, x, y, kind='linear', axis=-1,
        ...
        self._bounds_error = bounds_error  # used by fill_value setter
        self.copy = copy
    ...
    def fill_value(self, fill_value):
        ...
        if _do_extrapolate(fill_value):
            ...
            if self._bounds_error is None:
                self._bounds_error = True
    ...
    def _check_bounds(self, x_new):
        ...
        # If self._bounds_error is True, we raise an error if any x_new values
        ...
        if self._bounds_error and below_bounds.any():
            raise ValueError("A value in x_new is below the interpolation "
                             "range.")
        if self._bounds_error and above_bounds.any():
    ...
    def __call__(self, xi, method=None):
        ...
        if method == "linear":
            ...
            result = self._evaluate_nearest(indices,
                                            norm_distances,
                                            out_of_bounds)
        if not self._bounds_error and self.fill_value is not None:
